...
public class FoodItem {
    ...
    public static class FoodItemBuilder {
        ...
        private Category category;
        private String itemName;
        private Time deliveryTime; // for now we consider this as constant but we can use the store and user location to compute the distance between them using maps
        private Cost price;
        private int inventory;
